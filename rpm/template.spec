...
%global pkg_name sound_play_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-humble-sound-play-msgs
Version:        0.4.1
Release:        1%{?dist}
Summary:        ROS %{pkg_name} package

License:        BSD
URL:            http://ros.org/wiki/sound_play_msgs
...
%changelog
* Wed Sep 16 2026 Shingo Kitagawa <shingogo.5511@gmail.com> - 0.4.1-1
- Autogenerated by Bloom

* Wed Jun 10 2026 Shingo Kitagawa <shingogo.5511@gmail.com> - 0.4.0-2
- Autogenerated by Bloom

* Tue Jun 09 2026 Shingo Kitagawa <shingogo.5511@gmail.com> - 0.4.0-1
- Autogenerated by Bloom
